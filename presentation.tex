...
\begin{columns}
   \column{0.5\textwidth}
   \includegraphics[width=0.45\textwidth]{../phd_thesis/figures/results_discussion/simba_partial_bfs_expectation.pdf}

   \column{0.5\textwidth}
   \includegraphics[width=0.45\textwidth]{../phd_thesis/figures/results_discussion/C7incl_mb_la055_henrikas.pdf}
