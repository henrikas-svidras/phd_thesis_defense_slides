...
\begin{itemize}
   \centering
   \item[$\EB>1.8~\gev$] $\mathcal{B}(\BtoXsgamma) = (3.54 \pm 0.78 \pm 0.83 )\times 10^{-4}$ \\
   \item[$\EB>2.0~\gev$] $\mathcal{B}(\BtoXsgamma) = (3.06 \pm 0.56 \pm 0.47)\times 10^{-4} $ \\
\end{itemize}

\begin{itemize}
   \centering
   \item Compare with BaBar hadronic-tagged result:
   \item[$\EB>1.9~\gev$]  $\mathcal{B}(\BtoXsgamma) = (3.66 \pm 0.85 \pm 0.60)\times 10^{-4}$ \\
...
\scriptsize\centering
      ...
      \begin{itemize}
         ...
         \item[\ra] model/method dependant 
      \end{itemize}
...
\begin{tikzpicture}[remember picture, overlay]
   ...
   \node (dogbackup2) at (3,0.5) {};
   \node (catbackup1) at (0.8,2.85) {};
   \node (catbackup2) at (3,1.) {};
