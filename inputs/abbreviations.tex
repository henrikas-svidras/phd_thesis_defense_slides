...
\def\belletwo {\ensuremath{\mathrm{Belle~II}}\xspace}
...
\def\Zz      {\ensuremath{Z^0}\xspace}
\def\Z      {\ensuremath{Z}\xspace}
\def\Zstar      {\ensuremath{Z^{*}}\xspace}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%   QUARKS   %%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\def\Egamma{{\ensuremath{E_{\gamma}}}\xspace}

\def\pRecoil{{\ensuremath{p_{\mathrm{Recoil}}}}\xspace}
\def\pRecoilTheta{{\ensuremath{\theta_{\mathrm{Recoil}}}}\xspace}
\def\pRecoilPhi{{\ensuremath{\phi_{\mathrm{Recoil}}}}\xspace}
\def\mmrecoil{{\ensuremath{m^2_{\mathrm{Recoil}}}}\xspace}
\def\recoil{{\ensuremath{\mathrm{Recoil}}}}

\def\eemumugamma{{\ensuremath{\epem\rightarrow \mumu (\g_{\mathrm{ISR}})}}\xspace}
\def\eetautau{{\ensuremath{\epem\rightarrow\tautau}}\xspace}

\def\effdata{\ensuremath{\varepsilon_{\mathrm{DATA}}}\xspace}
\def\effmc{\ensuremath{\varepsilon_{\mathrm{MC}}}\xspace}
\def\effratio{\ensuremath{\frac{\varepsilon_{\mathrm{DATA}}}{\varepsilon_{\mathrm{MC}}}}\xspace}

\def\feiProb{\ensuremath{\mathcal{P}_{\mathrm{FEI}}}\xspace}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%   B to Xs gamma stuff %%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\def\BtoXsdgamma{{\ensuremath{B\rightarrow X_{\MakeLowercase{s/d}} \gamma}}\xspace}
\def\BtoXsgamma{{\ensuremath{B\rightarrow X_{\MakeLowercase{s}} \gamma}}\xspace}
\def\BtoXdgamma{{\ensuremath{B\rightarrow X_{\MakeLowercase{d}} \gamma}}\xspace}
\def\BptoXsgamma{{\ensuremath{B^+\rightarrow X_{\MakeLowercase{s}} \gamma}}\xspace}
\def\BztoXsgamma{{\ensuremath{B^0\rightarrow X_{\MakeLowercase{s}} \gamma}}\xspace}
\def\btosgamma{{\ensuremath{b\rightarrow s\gamma}}\xspace}
\def\btodgamma{{\ensuremath{b\rightarrow d\gamma}}\xspace}
\def\btosdgamma{{\ensuremath{b\rightarrow s(d)\gamma}}\xspace}

\def\BtoKstargamma{{\ensuremath{B\ra \Kstar(892)\g}}\xspace}

\def\ZMVA{{\ensuremath{\texttt{zernikeMVA}}}\xspace}

\def\piVeto{{\ensuremath{\mathcal{P}(\piz\ra\g\g)}}\xspace}

\def\etaVeto{{\ensuremath{\mathcal{P}(\eta\ra\g\g)}}\xspace}

\def\Mbc{{\ensuremath{M_{\mathrm{bc}}}}\xspace}
\def\DeltaE{{\ensuremath{\Delta E}}\xspace}
\def\Estar{{\ensuremath{E^*_{\gamma}}}\xspace}
\def\EB{{\ensuremath{E^B_{\gamma}}}\xspace}
\def\Ebeam{{\ensuremath{E_{\mathrm{beam}}}}\xspace}
\def\Xs{{\ensuremath{X_s}}\xspace}

\def\basf2{{\ensuremath{\texttt{basf2}}}\xspace}
\def\mcError{{\ensuremath{\texttt{mcError}}}\xspace}

\def\feiBp{{\ensuremath{\texttt{feiB}^+}}\xspace}
\def\feiBz{{\ensuremath{\texttt{feiB}^0}}\xspace}

\def\safeBtoXsgamma{\texorpdfstring{\BtoXsgamma}{B->Xsg}}
\def\safeBtoXsdgamma{\texorpdfstring{\BtoXsdgamma}{B->Xsdg}}
\def\safeB{\texorpdfstring{\B}{B}}

\def\EtildeB{{\ensuremath{\tilde{E}_{\gamma}^B}}\xspace}